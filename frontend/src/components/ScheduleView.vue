    ...
    <div class="flex justify-center items-center w-full h-full bg-gray-300 bg-opacity-30">
      <transition name="slide-fade">
        <div v-if="category.isShow"
          ...
          <div
              class="category-items flex flex-col py-1 text-start overflow-x-hidden overflow-y-auto select-none h-[26.5rem]">
            <draggable
                class="list-group"
          ...
          <div class="absolute bottom-0 left-0 w-full h-[2.5rem] flex items-center select-none"
               @click="addCategory">
            <div
                class="item flex items-center w-full px-3 rounded hover:bg-gray-200 cursor-pointer h-full">
      ...
      <div
          class="h-[90%] flex flex-col w-5/6 bg-white rounded p-6 border-yellow-500 border-t-[5px] relative">
        <FullCalendar
            class="z-10"
            id="calendar"
