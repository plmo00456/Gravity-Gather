                ...
                <ul class="flex text-gray-100 font-bold text-xl">
                    <li class="mr-1 hover:text-blue-400">
                        <router-link
                                ...
                                class="px-4 py-2" to="/">미팅룸</router-link>
                    </li>
                    <li class="mr-1 hover:text-blue-400">
                        <router-link
                                :class="{'text-blue-400': $route.name === 'scheduleView'}"
                                class="px-4 py-2" to="/schedule">일정</router-link>
                    </li>
                    <li class="hover:text-blue-400">
                        <router-link
                                :class="{'text-blue-400': $route.name === 'communityView'}"
                                class="px-4 py-2" to="/community">커뮤니티</router-link>
                    </li>
                </ul>
            </div>
            ...
            <form @submit.prevent="userUpdate">
                <div class="flex flex-col items-center p-5">
                    <div class="flex w-[6rem] items-center h-[6rem] mb-3 justify-center relative cursor-pointer">
                        ...
                        <input id="profile-photo-input" name="profile-image" @click="handleImageUpload" class="hidden"
