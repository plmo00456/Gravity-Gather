    ...
    <div id="main-room-view" class="flex justify-center bg-right-top bg-[length:110%_120%] text-white"
        ...
        <div class="flex flex-col justify-center center-window w-5/6 h-full">
            ...
            <div id="main-window" class="main-window w-full relative">
                <div v-bind:style="{'left': `${participant.x}px`, 'top' : `${participant.y}px`}"
                     class="absolute flex flex-col justify-center items-center"
                     v-for="participant in participants" :key="participant.seq">
                    <div class="shadow-hard chat-text relative break-words min-w-[10rem] max-w-[15rem] bg-gray-100 text-black px-3 py-1 rounded-xl mb-3 border border-gray-500">
                        <span class="w-full">aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</span>
                    </div>
                    <img class="w-36" :src="getCharacterImage(participant.roomCharacter)" alt="캐릭터">
                    <span class="rounded-3xl bg-gray-800 bg-opacity-60 px-3 py-0.5 mt-2 text-sm">{{participant.nickname}}</span>
                </div>
                <!--                <img v-bind:style="{'left': randomCharacterLocation().x, 'top' : randomCharacterLocation().y}" class="absolute left-0 top-0 w-36" src="@/assets/image/character/c1.png" alt="캐릭터">-->
                <!--                <img class="absolute left-0 top-0 w-36" src="@/assets/image/character/c2.png" alt="캐릭터">-->
                <!--                <img class="absolute left-0 top-0 w-36" src="@/assets/image/character/c3.png" alt="캐릭터">-->
                <!--                <img class="absolute left-0 top-0 w-36" src="@/assets/image/character/c4.png" alt="캐릭터">-->
                <!--                <img class="absolute left-0 top-0 w-36" src="@/assets/image/character/c5.png" alt="캐릭터">-->
                <!--                <img class="absolute left-0 top-0 w-36" src="@/assets/image/character/c6.png" alt="캐릭터">-->
            </div>
        </div>
            ...
            if (data.type1 === 'room') {
                if (data.type2 === 'chat' || data.type2 === 'enter' || data.type2 === 'leave') {
                    ...
                    if (data.type2 === 'enter' || data.type2 === 'leave') {
                        if(data.type2 === 'leave'){
                            console.log("senderSeq : " + data.senderSeq);
