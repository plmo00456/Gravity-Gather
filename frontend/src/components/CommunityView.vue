...
export default {
    ...
    methods: {
        ...
        clickOrderBtn(e){
            ...
            this.setting.order.contextOption.x = el.offsetLeft;
            this.setting.order.contextOption.y = el.offsetTop + el.clientHeight + 10;
        },
...
<template>
    <div id="main-view" class="flex items-center bg-main_background bg-cover h-[93%] justify-center">
        <div class=" flex flex-col items-center bg-white w-5/6 h-full overflow-y-auto rounded">
            <div class="flex flex-col items-start w-4/6">
                <div class="relative overflow-hidden bg-pattern_2 bg-cover flex flex-col items-start bg-gray-300 w-full h-[6rem] my-5 p-5 rounded-3xl">
                    ...
                    <img class="absolute right-2 -top-3 w-[17%]" src="@/assets/image/character/c3.png" alt="">
                </div>
                <div class="flex justify-between items-center w-full mb-5">
                    <button class="text-white px-3 py-2 bg-blue-600 rounded text-sm hover:bg-blue-500" type="button">
                ...
                <div class="sticky-element bg-white flex justify-between items-center border-gray-300 border-y w-full h-[5rem] px-2">
                    ...
                    <div class="flex relative">
                        <form @submit.prevent="clickSearchBtn">
                            <input type="text" placeholder="검색" v-model="articleCondition.search"
                        ...
                        <div v-for="article in communityStore.articleList" :key="article.seq"
                            ...
                            <div class="w-[80%] flex flex-col pl-2">
                                <div class="flex items-center text-gray-500">
                                    ...
                                    <span class="">3 분전</span>
                                </span>
                                </div>
                                <div class="flex mt-2">
                                    <span class="article-title text-gray-700 font-semibold text-lg cursor-pointer hover:text-blue-400">{{ article.title }}</span>
                                </div>
                            </div>
