...
export default {
  ...
  data() {
    ...
    return {
      ...
      roomCharacterValue: {roomCharacter: 1, img: this.getCharacterImage(1)},
      roomCharacter: [
        {roomCharacter: 1, img: this.getCharacterImage(1)},
        {roomCharacter: 2, img: this.getCharacterImage(2)},
        {roomCharacter: 3, img: this.getCharacterImage(3)},
  ...
  methods: {
    ...
    myInfoShowFn() {
      ...
      this.roomCharacterValue = {
        ...
        img: this.getCharacterImage(this.user.roomCharacter)
      }
